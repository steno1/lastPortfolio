  ...
  return (
    <Modal className="theme__modal">
        ...
        <div className="theme__primary-wrapper">
            ...
            {
            primaryColors.map((pColor, index)=><PrimaryColor 
                key={index} className={pColor.className}/>)
        }
            </div>
        ...
        <div className="theme__background-wrapper">
            ...
            <div className="theme__background-colors">
                {
                    backgroundColors.map((bColor, index)=><BackgroundColor 
      key={index} className={bColor.className}/>)
                }
            </div>
        </div>
    </Modal>
